...
public class Addon_Lanterns
{
	...
	public static class BlockLanternPaper extends Block implements FCIBlock
	{
		...
		{
			blockIcon = Register.registerIcon("ginger_lantern_paper_anim");
			TopIcon = Register.registerIcon("ginger_lantern_paper_top");
		}
	...
	public static class BlockLanternSteel extends Block
	{
		...
		public Icon getIcon(int Side, int Meta)
		{
			return Side < 2 ? TopIcon : BaseIcon;
		}
		public void registerIcons(IconRegister Register)
		{
			blockIcon = Register.registerIcon("ginger_lantern_steel");
			BaseIcon = Register.registerIcon("ginger_lantern_steel_base");
			TopIcon = Register.registerIcon("ginger_lantern_steel_top");
		}
	}
