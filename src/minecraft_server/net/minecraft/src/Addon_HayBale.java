...
public class Addon_HayBale {
	...
	public static class BlockBale extends Block implements FCIBlock {
		...
		public int onBlockPlaced(World var1, int var2, int var3, int var4, int var5, float var6, float var7, float var8,
				int var9) {
			if (var5 < 2)
				return 0;
			else if (var5 < 4)
		...
		public void onBlockPlacedBy(World var1, int var2, int var3, int var4, EntityLiving var5,
				ItemStack var6) {/*
													 * int var7 = FCUtilsMisc.
													 * ConvertPlacingEntityOrientationToBlockFacing(var5);
													 * 
													 * if(var7<2)var7=0; else if(var7<4)var7=1; else
													 * var7=2; this.SetFacing(var1, var2, var3, var4,
													 * var7);//
													 */
		}
	}
